...
Room* layout6() {
    ...
    // FLOORS
    Platform _platform1((Position){.x = 15, .y = 27}, (Position){.x = 100, .y = 29});
    ...
    Platform _platform9((Position){.x = 77, .y = 24}, (Position){.x = 81, .y = 27});
    ...
    StaticBox start_region = StaticBox((Position){.x = 116, .y = 29}, (Position){.x = 119, .y = 33});
